...
def train_one_epoch_pez_contrastive_noshd(
    epoch: int,
    ...
    use_random_trigger = args.use_random_trigger and epoch >= args.model_neg_weight_start_epoch
    logger.info(f"| {should_prompt_update=} | {use_random_trigger=} |")
...
def train_prompt_tuning_pez_contrastive_noshd(
    wm_model: PreTrainedModel,
    soft_prompt: PEZSoftPrompt,
    wm_loader: DataLoader,
    main_loader: DataLoader,
    ...
    for epoch in range(args.num_train_epochs):
        ...
        train_res = train_one_epoch_pez_contrastive_noshd(
            epoch=epoch,
            wm_model=wm_model,
...
def main(args):
    ...
    try:
        ...
        train_prompt_tuning_pez_contrastive_noshd(
            wm_model=wm_model,
            soft_prompt=soft_prompt,
            wm_loader=wm_loader,
            main_loader=main_loader,
