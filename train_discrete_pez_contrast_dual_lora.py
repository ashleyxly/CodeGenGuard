...
def train_one_epoch_pez_contrastive_dual_adapter(
    epoch: int,
...
def train_prompt_tuning_pez_contrastive_dual_adapter(
    dual_model: PeftModel,
    soft_prompt: PEZSoftPrompt,
    wm_loader: DataLoader,
    distill_loader: DataLoader,
    ...
    for epoch in range(args.num_train_epochs):
        ...
        train_res = train_one_epoch_pez_contrastive_dual_adapter(
            epoch=epoch,
...
def main(args):
    ...
    if args.prompt_init == "vocab":
        ...
        init_indices = torch.randint(0, model_vocab_size - 500, (128, n_prefix_tokens))
    ...
    try:
        ...
        train_prompt_tuning_pez_contrastive_dual_adapter(
            dual_model=dual_model,
            soft_prompt=soft_prompt,
            wm_loader=wm_loader,
            distill_loader=distill_loader,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_neg_weight_start_epoch", type=float, default=2)
